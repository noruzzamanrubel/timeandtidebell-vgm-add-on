 ...
 * @subpackage Timeandtidebell_Vgm_Add_On/admin
 */
 ...
 */
class Timeandtidebell_Vgm_Add_On_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/timeandtidebell-vgm-add-on-admin.css', array(), $this->version, 'all' );
